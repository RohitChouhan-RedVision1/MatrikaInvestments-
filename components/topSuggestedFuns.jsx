            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">{fund.schemeCategory}</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-2 items-center text-center w-full md:w-1/2">
                <div
                  className="md:text-right"
                  onClick={() => handleSelectFunds(fund)}
                >
                  <p className="text-sm text-gray-300">Corpus</p>
                ...
                >
                  {(fund?.fiveyear_navEndDate &&
                    fund.fiveyear_navEndDate !== "0.00" && (
                      <div>
                        <p className="text-sm text-gray-300">NAV</p>
                        <p className="font-medium text-gray-200">
                          ₹{fund?.fiveyear_navEndDate}
                        </p>
                      </div>
                  ...
                  (fund?.sixmonth_navEndDate &&
                    fund.sixmonth_navEndDate !== "0.00" && (
                      <div>
                        <h3 className="text-sm text-gray-300">NAV</h3>
                        <p className="text-lg font-medium text-gray-200">
                          ₹ {fund?.sixmonth_navEndDate}
                        </p>
                      </div>
