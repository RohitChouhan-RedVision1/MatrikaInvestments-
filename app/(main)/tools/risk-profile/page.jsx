    ...
    return (
      <Form {...form}>
        ...
        >
              ...
              <FormItem>
                <FormControl>
                  <textarea
                    placeholder="Message"
                    {...field}
                    className="w-full border border-gray-500 p-1 rounded px-3 py-2"
                    aria-label="Message"
                  />
                </FormControl>
                <FormMessage />
          ...
          {/* Submit Button */}
          <Button
            className=" bg-[var(--rv-primary)] hover:bg-[--rv-secondary]"
            type="submit"
          >
...
Here are the answers you provided:
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setTimeout(() => {
          router.push("/thank-you"); // ✅ redirect page
        }, 1500);
      } else {
  ...
  const getResultMessage = () => {
    if (score >= 10 && score < 20)
      return { message: "Conservative", color: "text-green-300" };
    if (score >= 20 && score <= 26)
      return { message: "Moderately Conservative", color: "text-green-600" };
    if (score >= 27 && score <= 33)
      return { message: "Moderate", color: "text-yellow-300" };
    if (score >= 34 && score <= 39)
      return { message: "Moderately Aggressive", color: "text-yellow-600" };
    if (score >= 40 && score <= 50)
      return { message: "Aggressive", color: "text-red-500" };
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        {isQuizCompleted ? (
          <div className="flex flex-col items-center text-center">
            ...
            <h5
              className={`text- 4xl font-semibold mb - 4 border-2 border-[var(--rv-primary)] p-2 w-full mb-3 rounded ${
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-inner">
              ...
              <ul className="mt-2 text-left">
                <li className="mb-3 text-gray-600">
                  ...
                  Conservative investors are investors who want stability and
                  are more concerned with protecting their current investments
                  than increasing the real value of their investments.
                </li>
                <li className="mb-3 text-gray-600">
                  <span className="text-bold text-lg text-gray-900">
                    Moderately Conservative:{" "}
                  </span>
                  M Moderately conservative investors are investors who want to
                  protect their capital, and achieve some real increase in the
                ...
                <li className="mb-3 text-gray-600">
                  ...
                  Moderate investors are long-term investors who want reasonable
                  but relatively stable growth. Some fluctuations are tolerable,
                  but investors want less risk than that attribute to a fully
                ...
                <li className="mb-3 text-gray-600">
                  ...
                  Moderately Aggressive investors are long-term investors who
                  want good real growth in their capital. A fair amount of risk
                  is acceptable.
                </li>
                <li className="mb-3 text-gray-600">
                  <span className="text-bold text-lg text-gray-900">
                  ...
                  Aggressive investors are long-term investors who want high
                  capital growth. Substantial year-to-year fluctuations in value
                  are acceptable in exchange for a potentially high long-term
                  return.
                </li>
              </ul>
            </div>
            <button
              ...
              className="mt-6 btn btn-primary text-white px-4 py-2 rounded-lg hover:bg-gray-800"
            >
              Back Home
            </button>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-4 ">
              {questions[currentQuestionIndex]?.answers?.map(
                (answer, index) => (
                  <div key={index} className={`${styles.rvrowradiolabel} `}>
                    <input
                      type="radio"
                      id={`answer - ${index} `}
                      name="answer"
                      ...
                      className={`mr-2 ${styles.radiobtn}`}
                    />
                    <label
                      htmlFor={`answer - ${index} `}
                      className={`text-lg text-gray-800 ${styles.radiolabel}`} 
                    >
                      {answer.text}
                    </label>
                  </div>
            ...
            <Button
              ...
              className="text-white border px-4 py-2 rounded-lg  w-1/4 bg-[var(--rv-primary)] hover:bg-[--rv-secondary] "
            >
              Next
            </Button>
          </div>
